  ...
  protected readonly developmentSteps: readonly DevelopmentStep[] = [
    {
      ...
      description: 'Created the browser-based editor shell with routing, shared styling, and standalone Angular components.',
      artifacts: ['Application bootstrap', 'Main editor route', 'Global SCSS theme'],
    },
    {
      title: 'Editor workspace shell',
      description: 'Built the primary RPG Forge workspace with left, center, and right docking regions.',
      artifacts: ['Toolbar', 'Docking panels', 'Responsive layout'],
    },
    {
      title: 'Map rendering viewport',
      description: 'Implemented the central viewport used to preview the current map with camera, layer, and renderer support.',
      artifacts: ['Render viewport component', 'Camera model', 'Map renderer'],
    },
    {
      title: 'Editor state and map services',
      description: 'Added shared editor state plus map editing services for active tools, zoom, selected assets, layers, and collision summaries.',
      artifacts: ['Editor state service', 'Map editor service', 'Shared map models'],
    },
    {
      title: 'Tileset and asset workflows',
      description: 'Created asset browsing and tileset editing panels so tile metadata, terrain, and collision state can be inspected.',
